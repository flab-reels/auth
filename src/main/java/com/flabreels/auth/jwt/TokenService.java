...
public class TokenService {
    ...
    private long accessTokenPeriod = 1000L * 60L * 10L; //// 10min
    ...
    public TokenResponseDto regenerateAccessTokenWithRefreshToken(String refreshToken){
        ...
        if ((verifyToken(refreshToken)) && (refreshToken.equals(dbRefreshToken)) && (dbEmail != null)){
